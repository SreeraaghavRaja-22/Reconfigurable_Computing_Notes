...
// COMBINE RANDOM TESTS with DIRECTED TESTS
...
module add_tb3 #(
    ...
    initial begin
        cg_inst = new(); // create an instance of the cover group
        $timeformat(-9, 0, " ns");
        ...
        // can display coverage so we don't have to display the coverage GUI
...
module add_tb4 #(
    ...
    covergroup cg @(posedge clk);
        ...
        // here.
        in0_in1_eq_0: coverpoint (in0 == '0 && in1 == '1) {bins true = {1'b1};}
    ...
    initial begin
        ...
        // MORE DIRECTED TESTS FOR COVERAGE STATEMENTS
